  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(Sofa, { className: 'w-12 h-12 text-pink-600 mx-auto' }),
      ...
      React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement('input', {
                ...
                className: `block w-full px-4 py-3 rounded-md border ${errors.password ? 'border-red-500' : 'border-gray-300'} focus:ring-pink-500 focus:border-pink-500`,
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(LogIn, { className: 'w-5 h-5 text-pink-200 absolute left-3 top-3' }),
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'a',
            { href: '/register', className: 'text-pink-600 hover:text-pink-800' },
            'Register here'
          )
        )
      )
