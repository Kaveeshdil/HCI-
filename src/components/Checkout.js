      ...
      <div className="container mx-auto flex-1 p-6">
        {isSubmitted ? (
          <div className="bg-white rounded-2xl shadow-xl p-6 text-center animate-fadeIn">
            ...
            <button
              onClick={() => setShowCheckout(false)}
              className="p-3 bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition-all duration-300"
            >
              Return to Dashboard
            </button>
          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-t pt-4">
                    ...
                    <button
                      ...
                      className="w-full p-3 mt-4 bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition-all duration-300 flex items-center justify-center gap-2"
                    >
                      Complete Purchase
                    </button>
                  </div>
