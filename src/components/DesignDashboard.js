...
import { LogOut, ChevronDown, ChevronUp, Trash2, RotateCcw, Save, Edit2, ShoppingCart, X, Armchair, Bed, Lamp, Sofa, Table, Tv, Book } from 'lucide-react';
...
const DesignDashboard = ({ designs, setDesigns }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-50 to-rose-100 flex flex-col">
      <nav className="bg-gradient-to-r from-pink-600 to-rose-800 text-white p-4 shadow-lg sticky top-0 z-20">
        <div className="container mx-auto flex justify-between items-center">
          <h1 className="text-2xl font-extrabold tracking-tight">Furniture Design Studio</h1>
          <div className="flex items-center gap-4">
            <button
              onClick={() => setShowCart(!showCart)}
              className="flex items-center gap-2 px-4 py-2 bg-pink-900 hover:bg-pink-950 rounded-lg transition-all duration-300"
            >
          ...
          <div className="lg:col-span-1 bg-white rounded-2xl shadow-xl p-6 space-y-6">
            <div>
              <button
                ...
                className="w-full flex justify-between items-center text-lg font-semibold text-gray-900 hover:text-pink-600 transition-colors"
              >
                Room Settings
                ...
                <div className="mt-4 space-y-4 animate-fadeIn">
                  {productCatalog.map((product) => (
                    <div key={product.id} className="p-4 bg-gray-50 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                      <product.icon className="w-32 h-32 text-gray-600 mx-auto mb-2" />
                      <p className="font-medium text-gray-900">{product.name}</p>
                      <p className="text-gray-600">${product.price.toFixed(2)}</p>
                      <button
                        onClick={() => addFurniture(product)}
                        className="w-full p-2 mt-2 bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition-all duration-300 flex items-center justify-center gap-2"
                      >
                        Add to Room & Cart
                      </button>
                    </div>
                    ...
                    furniture.map((item, index) => (
                      ...
                      >
                        ...
                        <input
                          ...
                          className="w-full p-3 mt-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-all"
                        />
                        <input
                          type="number"
            ...
            <div className="flex gap-3">
              <button
                onClick={saveDesign}
                className="flex-1 p-3 bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition-all duration-300 flex items-center justify-center gap-2"
              >
                ...
                >
                  ...
                  <div className="flex gap-2 mt-3">
                    <button
                      ...
                      className="flex-1 p-2 bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition-all duration-300 flex items-center justify-center gap-2"
                    >
              ...
              <div className="space-y-4">
                ...
                <div className="border-t pt-4">
                  ...
                  <button
                    ...
                    className="w-full p-3 mt-4 Tom's bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition-all duration-300 flex items-center justify-center gap-2"
