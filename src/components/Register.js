  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(UserPlus, { className: 'w-12 h-12 text-pink-600 mx-auto' }),
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('input', {
              ...
              className: `mt-1 block w-full px-4 py-3 rounded-md border ${errors.email ? 'border-red-500' : 'border-gray-300'} focus:ring-pink-500 focus:border-pink-500`,
          ...
          React.createElement(
            ...
            React.createElement('input', {
              ...
              className: `mt-1 block w-full px-4 py-3 rounded-md border ${errors.password ? 'border-red-500' : 'border-gray-300'} focus:ring-pink-500 focus:border-pink-500`,
          ...
          React.createElement(
            ...
            React.createElement('input', {
              ...
              className: `mt-1 block w-full px-4 py-3 rounded-md border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'} focus:ring-pink-500 focus:border-pink-500`,
        ...
        React.createElement(
          ...
          React.createElement(
            'button',
            {
              ...
              } focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 font-medium`
            },
            React.createElement(UserPlus, { className: 'w-5 h-5 text-pink-200 absolute left-3 top-3' }),
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'a',
            { href: '/', className: 'text-pink-600 hover:text-pink-800' },
            'Sign in here'
          )
        )
      )
